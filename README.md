...
A deep learning-based web application that detects diseases in plant leaves using image classification. Users can upload a leaf image or capture one using their device camera, and the system instantly identifies the disease along with a confidence score.
...
The MobileNetV2 model processes and classifies the image
The predicted disease name and confidence score are returned to the user
